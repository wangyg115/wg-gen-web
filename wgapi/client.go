...
type Client interface {
	...
	AddPeer(context.Context, *AddPeerRequest) (*CfgPeerResponse, error)

	// RemovePeer deletes a Peer from the WireGuard interfaces table by their
	// public key,
	RemovePeer(context.Context, *RemovePeerRequest) (*CfgPeerResponse, error)
}
